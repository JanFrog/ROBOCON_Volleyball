...
ukf = UKF(drag_coefficient=0.01, sigma_Q=0.04, sigma_R=0.2, alpha=0.9, beta=3, kappa=1.7)
...
if __name__ == "__main__":
    ...
    while pg.state[2] >= 0:
        ...
        try:
            state_filtered, P = ukf.forward(state_filtered, P, pg.get_state(add_noise=True, sigma= 0.1)[:3], dt)
        except:
